...
const getStudentsByClass = async (req, res, next) => {
  try {
    console.log('getStudentsByClass called with:', { params: req.params, query: req.query, user: req.user });
...
module.exports = { markAttendance, getAttendanceHistory, getStudentsByClass };